 ...
 */
final class Version20210721112426 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(100) NOT NULL, lastname VARCHAR(100) NOT NULL, email VARCHAR(255) NOT NULL, nickname VARCHAR(100) NOT NULL, password VARCHAR(150) NOT NULL, picture VARCHAR(255) DEFAULT NULL, country VARCHAR(100) NOT NULL, date_of_birth DATE NOT NULL, role VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, published_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
